...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-scraperjs/node_modules/scraperjs/src/AbstractScraper.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-scraperjs/node_modules/scraperjs/src/AbstractScraper.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-scraperjs/node_modules/scraperjs/src/</a> &#187; AbstractScraper.js</div>
</div>
<div class="body">
 ...
 * @constructor
 */
var AbstractScraper = <span class="fstat-no" title="function not covered" >function() {</span>
	/**
	 ...
	 * @protected
	 */
<span class="cstat-no" title="statement not covered" >	this.statusCode = null;</span>
	/**
	 ...
	 * @protected
	 */
<span class="cstat-no" title="statement not covered" >	this.response = null;</span>
	/**
...
AbstractScraper.prototype = {
	 ...
	 * @public
	 */
	get: <span class="fstat-no" title="function not covered" >function(url, callback) {</span>
<span class="cstat-no" title="statement not covered" >		var that = this;</span>
<span class="cstat-no" title="statement not covered" >		request.get(url, <span class="fstat-no" title="function not covered" >function processGet(error, response, body) {</span></span>
...
<span class="cstat-no" title="statement not covered" >				that.response = response;</span>
<span class="cstat-no" title="statement not covered" >				that.statusCode = response.statusCode;</span>
<span class="cstat-no" title="statement not covered" >				that.body = body;</span>
<span class="cstat-no" title="statement not covered" >				that.url = response.request.href;</span>
<span class="cstat-no" title="statement not covered" >				that.loadBody(<span class="fstat-no" title="function not covered" >function(err) {</span></span>
...
<span class="cstat-no" title="statement not covered" >		return this;</span>
	 ...
	 * @public
	 */
	request: <span class="fstat-no" title="function not covered" >function(options, callback) {</span>
<span class="cstat-no" title="statement not covered" >		var that = this;</span>
<span class="cstat-no" title="statement not covered" >		request(options, <span class="fstat-no" title="function not covered" >function processRequest(error, response, body) {</span></span>
<span class="cstat-no" title="statement not covered" >			if (error) {</span>
<span class="cstat-no" title="statement not covered" >				callback(error);</span>
			} else {
<span class="cstat-no" title="statement not covered" >				that.response = response;</span>
...
<span class="cstat-no" title="statement not covered" >		return this;</span>
	 ...
	 * @public
	 */
	getStatusCode: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return this.statusCode;</span>
	},
	/**
	 ...
	 * @public
	 */
	getResponse: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return this.response;</span>
	},
	/**
	 ...
	 * @public
	 */
	getBody: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return this.body;</span>
	 ...
	 * @protected
	 */
	loadBody: <span class="fstat-no" title="function not covered" >function(done) {</span>
...
<span class="cstat-no" title="statement not covered" >		return this;</span>
	 ...
	 * @public
	 */
	scrape: <span class="fstat-no" title="function not covered" >function(scraperFn, callbackFn, args) {</span>},
	/**
	 * Closes the scraper.
	 *
	 * @return {!AbstractScraper} This scraper.
 ...
 * @static
 */
AbstractScraper.create = <span class="fstat-no" title="function not covered" >function(ScraperType, url, options) {</span>
<span class="cstat-no" title="statement not covered" >	var promise = new ScraperPromise(new ScraperType(options));</span>
<span class="cstat-no" title="statement not covered" >	if (url) {</span>
<span class="cstat-no" title="statement not covered" >		promise.get(url);</span>
	}
